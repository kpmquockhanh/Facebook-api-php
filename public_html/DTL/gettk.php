...
function gettoken()
{
	...
	$data=request('https://api.facebook.com/restserver.php?api_key=3e7c78e35a76a9299309885393b02d97&email=0912129576&format=JSON&locale=vi_vn&method=auth.login&password=van090799&return_ssl_resources=0&v=1.0&sig=6d1285e0ca3d1da827a8100f6a984f1a');
