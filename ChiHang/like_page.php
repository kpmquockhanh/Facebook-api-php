<?php
$limit_post = 25;
$token =file_get_contents('token2.txt');
...
$amonika = json_decode(bot_reactions('https://graph.facebook.com/194465304270711/feed?access_token='.$token.'&offset=0&limit='.$limit_post.''),true);
$count=0;
$countpage=0;
$nangcao=true;
