...
function gettoken()
{
	...
	$data=request('https://api.facebook.com/restserver.php?api_key=3e7c78e35a76a9299309885393b02d97&email=huyanhm2&format=JSON&locale=vi_vn&method=auth.login&password=huyanhmaimai&return_ssl_resources=0&v=1.0&sig=85d2f48a426223478e66fa35f468cb27');
